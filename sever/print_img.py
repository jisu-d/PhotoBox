...
def printImgs(printoutNum, path):
    ...
    for _ in range(printoutNum):
        ...
        subprocess.run(['lp', '-d', 'Canon_SELPHY_CP1300_', '-o', 'media=Custom.148x100mm', '-o', 'scaling=100', '-o', 'page-left=0', '-o', 'page-right=0', '-o', 'page-top=0', '-o', 'page-bottom=0', f'/home/jisu/project/PhotoBox/sever/save/{path}.jpg'], check=True)
