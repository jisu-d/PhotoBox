...
def read_json():
    ...
    file_path = "/home/jisu/test/PhotoBox/sever/frame_info.json"
...
def creative_collage_images(data):
    ...
    background = cv2.imread(f'/home/jisu/test/PhotoBox/sever/frame/{title_parts[0]}/{title_parts[1]}.png', cv2.IMREAD_UNCHANGED)
    ...
    file_path = save_image_with_count_and_random_hex(background_with_overlays, '/home/jisu/test/PhotoBox/sever/save')
